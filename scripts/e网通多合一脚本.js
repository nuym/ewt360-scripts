...
setTimeout(function(){var cX = $("div[id='replaybtn']:visible").click();}, 100);
 ...
 ~function (global) {
     ...
     var helper = function (eHookContext, timerContext, util) {
         return {
             applyUI: function () {
                 var style = '._th-container ._th-item{margin-bottom:3px;position:relative;width:0;height:0;cursor:pointer;opacity:.3;background-color:deeppink;border-radius:100%;text-align:center;line-height:30px;-webkit-transition:all .35s;-o-transition:all .35s;transition:all .35s;right:30px}._th-container ._th-item,._th-container ._th-click-hover,._th_cover-all-show-times ._th_times{-webkit-box-shadow:-3px 4px 12px -5px black;box-shadow:-3px 4px 12px -5px black}._th-container:hover ._th-item._item-x2{margin-left:18px;width:45px;height:45px;line-height:45px}._th-container:hover ._th-item._item-x-2{margin-left:17px;width:43px;height:43px;line-height:43px}._th-container:hover ._th-item._item-xx2{width:41px;height:41px;margin-left:16px;line-height:41px}._th-container:hover ._th-item._item-xx-2{width:36px;height:36px;line-height:36px;margin-left:14px}._th-container:hover ._th-item._item-reset{width:33px;line-height:33px;height:33px;margin-left:10px}._th-click-hover{position:relative;-webkit-transition:all .5s;-o-transition:all .5s;transition:all .5s;height:60px;width:60px;cursor:pointer;opacity:.3;border-radius:100%;background-color:deeppink;text-align:center;line-height:60px;right:0}._th-container:hover{left:-5px}._th-container{font-size:12px;-webkit-transition:all .5s;-o-transition:all .5s;transition:all .5s;left:-35px;top:20%;position:fixed;-webkit-box-sizing:border-box;box-sizing:border-box;z-index:100000;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}._th-container ._th-item:hover{opacity:.8;background-color:#FFB6C1;color:aliceblue}._th-container ._th-item:active{opacity:.9;background-color:#1b3a26;color:aliceblue}._th-container:hover ._th-click-hover{opacity:.8}._th-container:hover ._th-item{opacity:.6;right:0}._th-container ._th-click-hover:hover{opacity:.8;background-color:#FF1493;color:aliceblue}._th_cover-all-show-times{position:fixed;top:0;right:0;width:100%;height:100%;z-index:99999;opacity:1;font-weight:900;font-size:30px;color:#4f4f4f;background-color:rgba(0,0,0,0.1)}._th_cover-all-show-times._th_hidden{z-index:-99999;opacity:0;-webkit-transition:1s all;-o-transition:1s all;transition:1s all}._th_cover-all-show-times ._th_times{width:300px;height:300px;border-radius:50%;background-color:rgba(255,20,147,0.51);text-align:center;line-height:300px;position:absolute;top:50%;right:50%;margin-top:-150px;margin-right:-150px}';
     ...
     async function getVideoTime() { // 获取周看课时长
         try {
             ...
             if (response.ok) { // 判断是否出现 HTTP 异常
                 ...
                 return { success: false, msg: `[e网通多合一脚本] 服务器返回异常 HTTP 状态码：HTTP ${response.status} ${response.statusText}.` };
             }
         } catch (reason) { // 若与服务器连接异常，返回异常信息
             return { success: false, msg: '[e网通多合一脚本] 连接服务器过程中出现异常，消息：' + reason.message };
         }
     }
     return setInterval(async function () {
         const result = await getVideoTime();
         if (result.success) {
             console.log(`[e网通多合一脚本] ${new Date()} 保持登录成功。`);
         } else {
